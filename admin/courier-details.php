<?php 
    ...
    if(isset($_GET['courier-id']) && isset($_GET['user-id'])){

        $courier_id = base64_decode($_GET['courier-id']);
                ...
                <div class="sender-details mt-5 p-5" style="background-color: whitesmoke;">
                    ...
                    <form method="POST" action="">
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `courier` WHERE `id` = '$courier_id' AND `user_id` = '$user_id' ");
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Courier's Volume:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <?php 
                            ...
                            $result = mysqli_query($connect, "SELECT * FROM `price` WHERE `courier_id` = '$courier_id' AND `user_id` = '$user_id' AND `total_price` != '' ");
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Courier Status:</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" id="form4Example1" class="form-control" name="ctracking"
