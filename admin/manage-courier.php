<?php 
    ...
    if(isset($_POST['update-status'])){
        ...
        if($status == 'delivered'){
            ...
            $result = mysqli_query($connect, "UPDATE `courier` SET `status`= 2 WHERE `id` = '$courier_id' ");
...
alert("Courier's Status Changed Successfully!");
javascript: history.go(-1);
</script>

<?php

                    $success = "Courier's Status Changed Successfully!";
            ...
            <div class="lg-offset-2 col-lg-8 col-md-12">
                <div class="sender-details mt-5 p-5" style="background-color: whitesmoke;">
                    ...
                    <form method="POST" action="">
                        ...
                        <h5 style="font-weight: bold;" class="text-center mb-5">Manage Courier</h5>
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Courier's Status:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Courier's Location:</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" id="form4Example1" class="form-control" name="location"
                                        placeholder="Courier's Location"
