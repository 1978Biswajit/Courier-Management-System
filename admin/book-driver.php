<?php 
    ...
    if(isset($_GET['courier-id']) && isset($_GET['user-id']) && isset($_GET['driver-id'])){
    ...
    if(isset($_POST['driver-submit'])){
        ...
        $result = mysqli_query($connect, "UPDATE `courier` SET `driver_id`='$driver_id' WHERE `id` = '$courier_id'");
