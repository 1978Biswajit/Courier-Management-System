            ...
            if($email_check_row == 0){
                ...
                if(strlen($password) > 5){
                    ...
                    if($password == $repassword){
                        ...
                        $result = mysqli_query($connect, "CALL insert_admin('$name','$contact','$city','$email','$password','$repassword')");
        ...
        <div class="container">
            ...
            if(isset($_SESSION['admin_login'])){
              ?>
                        ...
                        <a class="nav-link" href="manage-couriers.php">Request Orders</a>
                        <a class="nav-link" href="finish-courier.php">Finished Orders</a>
