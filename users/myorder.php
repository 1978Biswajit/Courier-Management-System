                ...
                <table class="table table-bordered table-striped table-hover mt-5 mb-5">
                    ...
                    <tbody>
                        <?php 
                                ...
                                $result = mysqli_query($connect, "SELECT * FROM `courier` WHERE `user_id` = '$user_id' ");
                        ...
                        <tr>
                            ...
                            <?php 
                                    ...
                                    $price_result = mysqli_query($connect, "SELECT * FROM `price` WHERE `user_id` = '$user_id' AND `courier_id` = '$courier_id' AND `total_price` != '' "); 
