<?php 
    ...
    //   header('location: myorder.php');
        ...
        $data_id = mysqli_query($connect, "SELECT `id` FROM `user` WHERE `email` = '$email'");
        $user_id;
        ...
        if(!($scity == $rcity)){
            ...
            if($scity == 'Dhaka' || $rcity == 'Dhaka'){
                ...
                $result = mysqli_query($connect, "INSERT INTO `courier`(`user_id`, `weight`, `volume`, `quantity`, `date`, `sender_name`, `sender_email`, `sender_contact`, `sender_address`, `sender_city`, `receiver_name`, `receiver_email`, `receiver_contact`, `receiver_address`, `receiver_city`, `tracking_id`) VALUES ('$user_id', '$cweight', '$cvolume', '$cquantity', '$cdate', '$sname', '$semail', '$scontact', '$saddress', '$scity', '$rname', '$remail', '$rcontact', '$raddress', '$rcity', '$tracking_id')");
    
                if($result){
    
                    $courier_data = mysqli_query($connect, "SELECT `id` FROM `courier` WHERE `tracking_id` =  '$tracking_id'");
                    $courier_id;
                    while($rowdata = mysqli_fetch_array($courier_data)){
                        $courier_id = $rowdata['id'];
                    }
    
                    $price_result = mysqli_query($connect, "INSERT INTO `price`(`user_id`, `courier_id`, `basic_price`, `weight_price`, `volume_price`) VALUES ('$user_id', '$courier_id', '$basic_price', '$weight_price', '$voulme_price')");
                ...
                $error = "Please Choose One City Dhaka To Order Courier! ";

            }

        } else{
            $error = "Please Select Different Cities To Order Courier!";
        }
...
<!-- cargo's form -->
<section class="courier-form mb-5">
    <div class="container">
            ...
            <div class="lg-offset-2 col-lg-8 col-md-12">
                <div class="sender-details mt-5 p-5" style="background-color: whitesmoke;">
                    ...
                    <form method="POST" action="">
                        ...
                        <h5 style="font-weight: bold;" class="text-center mb-5 mt-5">Courier's Details</h5>

                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Courier's Weight:</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="number" id="form4Example1" class="form-control" name="cweight"
                                        placeholder="Courier's Weight in Kilogram"
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Courier's Length:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Courier's Width:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Courier's Height:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example1">Courier's Quantity:</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="number" id="form4Example1" class="form-control" name="cquantity"
                                        placeholder="Courier's Quantity"
                        ...
                        <div class="form-outline mb-4">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="form4Example3">Courier's Type:</label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="button-sub text-center">
                            <!-- Submit button -->
                            <button type="submit" class="btn btn-dark btn-block mt-4" name="courier-submit">Proceed
                                Details</button>
                        </div>
